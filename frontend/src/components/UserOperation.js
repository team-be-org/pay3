  ...
  const renderWalletControlUI = () => (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      <div style={{marginTop: '20px'}}>
        <span style={{ color: "white", fontSize: "20px", marginTop: "50px"}}> 1, Create Your Virtual Wallet </span>
        <p/>
          <button onClick={mintNFT} className="cta-button">Create</button>
      </div>
      <div style={{marginTop: '20px'}}>
        <span style={{ color: "white", fontSize: "20px" }}> 2, Charge ETH</span>
        <p/>
        <span style={{ color: "white", fontSize: "20px" }}> val: </span>
        ...
        <input className="text-box" placeholder="Wallet Num" value={tokenId} onChange={handleChange} type="text" style={{width: "100px"}}/>
        <p/>
      ...
      <div style={{marginTop: '20px'}}>
      <span style={{ color: "white", fontSize: "20px" }}> 3, Subscription on </span>
        <p/>
        <button onClick={SubscriptionOn} className="cta-button">
          On
        </button>
      </div>
      <div style={{marginTop: '20px'}}>
      <span style={{ color: "white", fontSize: "20px" }}> 4, Other </span>
      <p/>
      <span style={{ color: "white", fontSize: "20px" }}> Subscription </span>
        <p/>
        <button onClick={SubscriptionOff} className="cta-button">
          Off
        </button>
        <p/>
        <span style={{ color: "white", fontSize: "20px" }}> Withdraw </span>
        <p/>
        <button onClick={WithdrawExecution} className="cta-button">
          Withdraw
        </button>
      </div>
      </div>
